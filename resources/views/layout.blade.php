...
<head>
    ...
    @if (app()->getLocale() == 'ar')
        ...
        <link href="{{ asset('css/app-rtl.min.css') }}" rel="stylesheet" type="text/css" id="light-style" />
        <link href="{{ asset('css/app-dark-rtl.min.css') }}" rel="stylesheet" type="text/css" id="dark-style" />
    @else
